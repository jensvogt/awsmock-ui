...
@Component({
    selector: 'application-upload',
    templateUrl: './application-upload-dialog.component.html',
    standalone: true,
    imports: [
        FormsModule,
        MatButton,
    ...
    styleUrls: ['./application-upload-dialog.component.scss'],
    providers: [BinaryFileUploadComponent]
})
export class ApplicationUploadDialog implements OnInit {
    ...
    constructor(private readonly snackBar: MatSnackBar, private readonly dialogRef: MatDialogRef<ApplicationUploadDialog>, @Inject(MAT_DIALOG_DATA) public data: any) {
    ...
    uploadFile(file: File | null): void {
        if (file) {
            ...
            reader.onload = () => {
                ...
                this.dialogRef.close({applicationName: this.applicationName, applicationCode: content.split(',')[1], version: this.version});
            };

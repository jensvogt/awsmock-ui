...
@Component({
    selector: 'application-service-count-chart-component',
    templateUrl: './application-service-count-chart.component.html',
    standalone: true,
    imports: [
        ChartComponent,
        MatCard,
    ...
    styleUrls: ['./application-service-count-chart.component.scss']
})
export class ApplicationServiceCountChartComponent implements OnInit {
    ...
    @ViewChild(`application-service-count-chart-component`) serviceCountChart: ChartComponent | undefined;
    ...
    loadServiceCountChart() {
        ...
        this.monitoringService.getMultiCounters('application_service_counter', 'action', start, end, 5, this.selectedTopx)
            .subscribe((data: any) => {
                if (data) {
                    ...
                    this.serviceCountChartOptions = {
                        ...
                        title: {text: "Application Service Count", align: "center"},

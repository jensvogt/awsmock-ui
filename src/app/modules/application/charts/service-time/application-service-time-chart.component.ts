...
@Component({
    selector: 'application-service-time-chart-component',
    templateUrl: './application-service-time-chart.component.html',
    standalone: true,
    imports: [
        ChartComponent,
        MatCard,
    ...
    styleUrls: ['./application-service-time-chart.component.scss']
})
export class ApplicationServiceTimeChartComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.loadApplicationServiceTimeChart();
    }

    loadApplicationServiceTimeChart() {

        let start = this.chartService.getStartTime(this.selectedTimeRange);
        let end = this.chartService.getEndTime();
        this.monitoringService.getMultiCounters('application_service_timer', 'action', start, end, 5)
            .subscribe((data: any) => {
                if (data) {
                    ...
                    this.applicationServiceTimeChartOptions = {
                        ...
                        title: {text: "Application Service Time", align: "center"},

...
@Component({
    selector: 'memory-chart-total-component',
            ...
            .subscribe((data: any) => {
                if (data) {
                    ...
                    this.memChartOptions = {
                        ...
                        title: {text: "Memory Usage Total", align: "center"},
                        ...
                        yaxis: {
                            min: 0, forceNiceScale: true, decimalsInFloat: 0, title: {text: "Memory [%]"}, labels: {offsetX: 10}
                        }
                    };
                }
            });

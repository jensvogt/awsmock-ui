...
@Component({
    selector: 'sns-database-time-chart-component',
    templateUrl: './sns-database-time-chart.component.html',
    standalone: true,
    imports: [
        MatCard,
        MatCardHeader,
    ...
    styleUrls: ['./sns-database-time-chart.component.scss']
})
export class SnsDatabaseTimeChartComponent implements OnInit {
    ...
    loadDatabaseChart() {
        ...
        this.monitoringService.getMultiCounters('sns_database_timer', 'action', start, end, 5, this.selectedTopx)
            .subscribe((data: any) => {
                if (data) {
                    ...
                    this.sqsDatabaseChartOptions = {
                        title: {text: 'SNS Database Time', left: 'center'},
                        tooltip: {
                            trigger: 'item',
                            axisPointer: {
                                type: 'cross'

...
@Component({
    selector: 'sqs-database-time-chart-component',
    templateUrl: './sqs-database-time-chart.component.html',
    standalone: true,
    imports: [
        MatCard,
        MatCardHeader,
    ...
    styleUrls: ['./sqs-database-time-chart.component.scss']
})
export class SqsDatabaseTimeChartComponent implements OnInit {
            ...
            .subscribe((data: any) => {
                if (data) {
                    ...
                    this.sqsDatabaseChartOptions = {
                        title: {text: 'SQS Database Time', left: 'center'},
                        tooltip: {
                            trigger: 'item',
                            axisPointer: {
                                type: 'cross'
